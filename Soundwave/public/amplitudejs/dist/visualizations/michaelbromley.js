	...
	*/
	...
	this.startVisualization = function( element ){
		...
		*/
		...
		this.fgCanvas.setAttribute('style', 'position: absolute; z-index: 10; visibility: visible; display: block');
		...
		*/
		...
		this.sfCanvas.setAttribute('style', 'position: absolute; z-index: 5; visibility: visible; display: block');
